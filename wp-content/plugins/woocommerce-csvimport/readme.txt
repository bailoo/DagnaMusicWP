...
I do not answer questions on the forum anymore. If you have questions about the add-ons or the free importer, fill in my [contact form](http://allaerd.org/support/). Before asking questions please read the [documentation](http://allaerd.org/knowledgebase/). If you have questions about the add-ons, make sure to add you order number!
