...
function gaconv()
{
    if(window.location.pathname =='/contact/' && jQuery('.alert.success .msg').text() !='')
    {
         (new (Image)).src ="//www.googleadservices.com/pagead/conversion/995527066/?label=nzklCL2BkGEQmpPa2gM&guid=ON&script=0";
         clearInterval(timeInt);
    }
}

setInterval(function () { gaconv(); }, 2000);
</script>
