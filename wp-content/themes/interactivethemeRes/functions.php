...
if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
  ...
  add_image_size('slide-image',980,367,true);
  add_image_size('home-wide-image',607,275,true);
  add_image_size('home-tall-image',287,275,true);
  add_image_size('home-small-image',290,144,true);
  add_image_size('blog-image',647,275,true);
